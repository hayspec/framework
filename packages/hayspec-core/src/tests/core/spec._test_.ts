...
//   spec1.test('foo1', async (context, stage) => {
//     stage.set('id', 100);
//     const id = stage.get('id');
//     context.isEqual(1, 0, 'foo1')
//   });
//   spec1.test('bar1', (context) => {
//     context.isEqual(1, 0, 'bar1')
//   });

//   const spec0 = new Spec<Data>();
//   spec0.test('foo0', (context, stage) => {
//     context.isEqual(1, 0, 'foo0A')
//     context.isEqual(1, 1, 'foo0B')
//   });
//   spec0.spec('spec1', spec1);
//   spec0.test('bar0', (context, stage) => {
//     context.isEqual(1, 0, 'bar0')
//   });
